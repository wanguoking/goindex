// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//unpkg.zhimg.com/mdui@0.4.3/dist/css/mdui.min.css">');
// markdown支持
...
function markdown(el, data) {
  if (window.md == undefined) {
    //$.getScript('https://unpkg.zhimg.com/markdown-it@10.0.0/dist/markdown-it.min.js',function(){
